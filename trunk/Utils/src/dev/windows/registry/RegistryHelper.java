 ...
 *******************************************************************************************************************************/
final public class RegistryHelper
{
  /**
   ...
   *****************************************************************************************************************************/
  public RegistryHelper() throws RegistryErrorException
  {
    checkOS();
    initMethods();
  }
...
//      regor.saveDword(key, "DWOR1D", Integer.toHexString(23));
    ...
    //AT FIRST THE OLD WAY IS USED!!
    {
      ...
      for (int x = 0; l != null && x != l.size(); x++) //getting the String value from the valueNames
      {
        ...
        System.out.println(x + ": " + l.get(x) + " == " + RegistryHelper.parseValue(buf)); //parses the byte buffer to String
      }
